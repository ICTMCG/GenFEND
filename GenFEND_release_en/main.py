...
parser.add_argument('--model_name', default = 'bert_genfend') #bert_genfend 
parser.add_argument('--root_path', default='./data/GossipCop/') #'./data/real_comments_trunc/'  #'./data/role_virtual_comments/'
...
parser.add_argument('--cmt_emb_dim', type = int, default = 1024)
